...
[Official Proxy Documentation](https://github.com/Sonarr/Sonarr/wiki/Reverse-Proxy#nginx-conf)
...
```nginx
location /<baseurl> {
  proxy_pass http://<hostname>:8989; ## Default <port> is 8989, adjust if necessary
