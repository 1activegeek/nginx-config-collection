...
[Official Proxy Documentation](https://github.com/Radarr/Radarr/wiki/Reverse-Proxy#nginx)
...
```nginx
location /<baseurl> {
  proxy_pass http://<hostname>:7878; ## Default <port> is 7878, adjust if necessary
